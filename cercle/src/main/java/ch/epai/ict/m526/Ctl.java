 ...
 * provides methods to manage the application's behavior.
 * </p>
 * <p>
...
public class Ctl {
     ...
     * specific functionality of this method is not yet implemented.
     * </p>
     * <p>
     ...
     */
    public void start() {
        Cercle cercle = view.insertDimensionsCercle();
        view.displayCercle(cercle);
        Point point = view.insertDimensionsPoint();
        view.displayPoint(point, cercle);
    }
}
